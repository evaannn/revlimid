...
func Help() {
	...
	fmt.Printf("%s %s\n", constants.White("3. spam message - params:"), constants.Green("<Server ID> <Channel ID> <Message To Spam>"))
	fmt.Printf("%s %s\n", constants.White("4. add reaction - params:"), constants.Green("<Channel ID> <Message ID> <Emoji>"))
	fmt.Printf("%s %s\n", constants.White("5. add reaction message - params:"), constants.Green("<Channel ID> <Message ID> <Reaction Message>"))
	fmt.Printf("%s %s\n", constants.White("6. change nickname - params:"), constants.Green("<Server ID> <Nickname>"))
	fmt.Printf("%s %s\n", constants.White("7. change status - params:"), constants.Green("<Content> <Status> <Type>"))
	fmt.Printf("%s %s\n", constants.White("8. add friend - params:"), constants.Green("<Username>"))
	fmt.Printf("%s %s\n", constants.White("9. remove friend - params:"), constants.Green("<User ID>"))
	fmt.Printf("%s %s\n", constants.White("10. check tokens - params"), constants.Green("<None>"))
}
...
func init() {
	...
	if err != nil {
		...
		fmt.Printf("%s\n", constants.Green("Error reading discord tokens from tokens.txt"))
